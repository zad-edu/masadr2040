...
const App: React.FC = () => {
    ...
    const handleBookingSubmit = (bookingData: Omit<Booking, 'id'>) => {
        // Validation (this is the final check before saving)
        ...
        if (editingBooking) { // if editing, exclude current booking from count
    ...
    return (
        <div className="bg-gray-100 min-h-screen text-gray-800">
            <div className="container mx-auto p-4 md:p-8">
                ...
                <footer className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
